...
const Navbar = ({cartCount, showSearch, setShowSearch, handleShowCart, hovercat, leavecat, Gotologin}) => {
  ...
  return (
    ...
    {menuBar && (
     ...
     <div className='rightnav'>
      ...
      <span onClick={Gotologin}><VscAccount style={{fontSize: '22px',}}  /> Account</span>
